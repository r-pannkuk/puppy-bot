...
def main():
    if(len(sys.argv) == 1 or sys.argv[1] == ''):
        print("./commands/memes/media/magneto/Magneto_Background.png")
        return


    # Determine if image exists in save files
    location = sys.argv[1]
    save_name = "./commands/memes/saves/magneto/" + hashlib.sha1(location.encode()).hexdigest() + ".png"
    ...
    if(len(os.listdir("./commands/memes/saves/magneto")) >= MAX_THRESHOLD):
        files = (os.path.join("./commands/memes/saves/magneto/", fn) for fn in os.listdir("./commands/memes/saves/magneto/"))
    ...
    magneto = Image.open("./commands/memes/media/magneto/Magneto_Background.png")
    hand = Image.open("./commands/memes/media/magneto/Magneto_Hand.png")
